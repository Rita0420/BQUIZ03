<?php $movie=$Movies->find($_GET['id']);?>
<div class="tab rb" style="width:87%;">
    <div style="background:#FFF; width:100%; color:#333; text-align:left">
        <video src="./images/<?=$movie['trailer'];?>" width="300px" height="250px" controls="" style="float:right;"></video>
        <font style="font-size:24px"> <img src="./images/<?=$movie['poster'];?>" width="200px" height="250px"
            ...
            <p style="margin:3px">影片分級 ： <img src="./icon/03C0<?=$movie['level'];?>.png" style="display:inline-block;"><?=$leveStr[$movie['level']];?></p>
